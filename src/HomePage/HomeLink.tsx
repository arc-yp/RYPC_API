...
function HomeLink() {
  return (
    <div className="min-h-screen">
      ...
      {/* Floating WhatsApp Button (improved styling & glow) */}
      <a
      ...
      >
        <div className="relative">
          {/* Outer glow ring */}
          <span className="absolute inset-0 rounded-full bg-green-500/80 blur-xl opacity-90 group-hover:opacity-40 transition" />
